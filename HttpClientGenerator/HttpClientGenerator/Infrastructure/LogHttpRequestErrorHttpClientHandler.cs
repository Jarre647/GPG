...
namespace HttpClientGenerator.Infrastructure
{
    ...
    public class LogHttpRequestErrorHttpClientHandler : DelegatingHandler
    {
        ...
        public LogHttpRequestErrorHttpClientHandler(ILoggerFactory logFactory)
        {
            if (logFactory == null)
            {
            ...
            _log = logFactory.CreateLogger<LogHttpRequestErrorHttpClientHandler>();
        }
